...
export HDF5_MPI="ON"
pip install git+https://github.com/h5py/h5py.git@3.12.1
...
# mpibind veros run --backend jax --device gpu --force-overwrite wave_propagation/wave_propagation.py -n 2 2 cat derecho_jax_multigpu_init.py
